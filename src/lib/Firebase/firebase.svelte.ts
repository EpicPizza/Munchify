  ...
  const getApp = (): FirebaseApp => {
    ...
    if (app == undefined) {
       const firebaseConfig = {
        apiKey: "AIzaSyCpnT98E4qf7lqdFKkW9xXCBBTBBIGC3XQ",
        authDomain: "laneyhackthon.firebaseapp.com",
        projectId: "laneyhackthon",
        storageBucket: "laneyhackthon.firebasestorage.app",
        messagingSenderId: "351781719646",
        appId: "1:351781719646:web:7e7fe9d859ba40c08d2ecf"
      };
